        ...
        <Form onSubmit={handleSubmit(onSubmit)}>
            ...
            <Controller
              ...
              render={({ field }) => (
                <Input
                  ...
                  invalid={errors.fecha_alta && true}
                  {...field}
                />
              )}
            />
          ...
          <div className="mb-1">
            ...
            <select
              ...
              onChange={(e) => setTipoOpe(e.target.value)}
            >
          ...
          <div className="mb-1">
            <Label className="form-label" for="comision">
          ...
          <div className="mb-1">
            ...
            <select
              className="form-select"
              id="asesor_id"
              {...register("asesor_exclusivo")}
            >
              {asesorObj?.map((option) => (
                <option
                  key={option.id}
                  value={option.nombre + " " + option.apellidos}
                >
