    ...
    const steps = [
        {
            ...
            icon: <User size={18} />,
            content: <ClienteForm stepper={stepper} idPropiedad={id.id}  type='wizard-modern' />
        },
        {
            id: 'direccion',
            title: 'Direccion',
            ...
            icon: <MapPin    size={18} />,
            content: <DireccionForm stepper={stepper} idPropiedad={id.id} type='wizard-modern' />
        },
        {
            id: 'general',
            title: 'General',
            ...
            content: <GeneralForm stepper={stepper} idPropiedad={id.id} type='wizard-modern' />
        },
        {
            id: 'basico',
            title: 'Basicos',
            ...
            content: <BasicosForm stepper={stepper} idPropiedad={id.id} type='wizard-modern' />
        },
        {
            id: 'caracteristica',
